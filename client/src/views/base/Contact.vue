    ...
    <div class="wrapper">
        ...
        <div class="container">
            <article>
                ...
                <section>
                    <form data-post-form @submit.prevent>
                        ...
                        <div class="input-form">
                            ...
                            <div class="input-form-group">
                                <input type="email" v-model="email" name="email" id="email" placeholder="이메일 주소를 입력해주세요" required :class="{ 'error': this.emailError }" />
                        ...
                        <div class="input-form editor">
                            ...
                            <div class="input-form-group">
                                ...
                                <p class="auto-validate-noti" :class="{ 'error': this.editorError }" v-if="this.editorError">{{ this.editorErrorMsg }}</p>
                            </div>
                        </div>
                        <div class="input-form-controls">
                            <input type="submit" class="btn btn-submit text-inverse" value="이메일 발송" @click="contact">
                        </div>
                    </form>
                </section>
            </article>
