  ...
  data () {
    return {
      ...
      iconNav: [
        ...
        { id: 7, title: '부동산', background: 'https://download.seaicons.com/icons/fps.hu/free-christmas-flat-circle/512/home-icon.png', link: '/place/realty' },
        { id: 8, title: '도서관', background: 'https://www.theacademyofcreativity.org/webdata/uploaded/images/c08z4f2z03fz4bdzf94z298z6a1z66aze46z002z26.png', link: '/place/library' },
