<template>
    <div class="wrapper">
        ...
        <Landing ref="scrollBase" :title="title" description="" background="https://www.dhnews.co.kr/news/photo/201905/102956_103026_2813.jpg" />
...
export default {
    ...
    beforeCreate() {
        let board_idx = this.$route.params.post_id
        this.$apollo.query({
